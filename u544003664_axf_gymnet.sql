...
--
-- Table structure for table `notificaciones_sucursal`
--
...
--
-- Dumping data for table `notificaciones_sucursal`
--
...
(30, 26, 11, NULL, 'Pecho: esta rutina unicamente es de pecho y cuida tu manguito rotador\nEspalda: esta rutina unicamente es de espalda', 0, '2026-06-01 06:10:53'),
(31, 26, 11, NULL, 'Pecho: esta rutina unicamente es de pecho y cuida tu manguito rotador\nEspalda: esta rutina unicamente es de espalda', 0, '2026-06-01 06:11:13');
...
(206, 30, 259, 1, 3, 10, 60, NULL, 'brazos no tan cerrados', 'Pecho', 'esta rutina unicamente es de pecho y cuida tu manguito rotador'),
(207, 30, 260, 2, 3, 10, 60, NULL, 'codos rectos', 'Pecho', 'esta rutina unicamente es de pecho y cuida tu manguito rotador'),
(208, 30, 258, 3, 3, 10, 60, NULL, 'muchas repeticiones', 'Pecho', 'esta rutina unicamente es de pecho y cuida tu manguito rotador'),
(209, 30, 265, 101, 3, 10, 60, NULL, NULL, 'Espalda', 'esta rutina unicamente es de espalda'),
(210, 30, 266, 102, 3, 10, 60, NULL, NULL, 'Espalda', 'esta rutina unicamente es de espalda'),
(211, 30, 269, 103, 3, 10, 60, NULL, NULL, 'Espalda', 'esta rutina unicamente es de espalda'),
(212, 31, 259, 1, 3, 10, 60, NULL, 'brazos no tan cerrados', 'Pecho', 'esta rutina unicamente es de pecho y cuida tu manguito rotador'),
(213, 31, 260, 2, 3, 10, 60, NULL, 'codos rectos', 'Pecho', 'esta rutina unicamente es de pecho y cuida tu manguito rotador'),
(214, 31, 258, 3, 3, 10, 60, NULL, 'muchas repeticiones', 'Pecho', 'esta rutina unicamente es de pecho y cuida tu manguito rotador'),
(215, 31, 265, 101, 3, 10, 60, NULL, NULL, 'Espalda', 'esta rutina unicamente es de espalda'),
(216, 31, 266, 102, 3, 10, 60, NULL, NULL, 'Espalda', 'esta rutina unicamente es de espalda'),
(217, 31, 269, 103, 3, 10, 60, NULL, NULL, 'Espalda', 'esta rutina unicamente es de espalda');
...
(68, 26, 15, NULL, '2026-06-01', '2026-06-30', 3, 1, 'Activa', NULL, '2026-06-01 01:17:07');
...
--
-- Indexes for table `notificaciones_sucursal`
--
...
--
-- AUTO_INCREMENT for table `notificaciones_sucursal`
--
ALTER TABLE `notificaciones_sucursal`
...
--
ALTER TABLE `rutinas`
  MODIFY `id_rutina` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
