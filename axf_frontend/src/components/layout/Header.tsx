...
export default function Header() {
  ...
  // Definimos a dónde lleva la casita dependiendo de quién esté conectado
  const homePath = user?.rol === 'maestro' ? '/sucursales' : '/dashboard';
  ...
  return (
    <header className="h-[60px] bg-[#071B2F] flex items-center justify-between px-6 shadow-md z-10 w-full shrink-0">
      ...
      <div className="flex items-center gap-6">
        ...
        {/* Aquí aplicamos la ruta dinámica */}
        <Link to={homePath} className="text-gray-400 hover:text-[#F26A21] transition-colors" title="Inicio">
